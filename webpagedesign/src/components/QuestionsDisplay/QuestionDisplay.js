...
export default () => {
    const questions = [{
        ...
        Question_Description : "Check these metrics to stay on top of your financial health",
        metric : [
        ...
        Question_Description : "Understanding your revenues and expenses you can figure out where you are doing well and where you can improve",
        metric : [{Label: "Fill out Income Statement", Description: "Here is the form to fill"}]
    },{
        Question : 'What is Cash Flow Statment?',
        Question_Description : "The cash flow statement tells you how much money is entering and leaving your business",
        metric : [{Label: "Fill out Cash Flow Statement", Description: "Here is the form to fill"}]
    }]


    return( <div className="Box-Display">
        {questions.map(question => (
            <div key={question.Question}>
                ...
                <div>
                    { question.metric.map(metric => {
                        return <MetricCheckBox value={metric.Description} key={metric.Label}>{metric.Label}</MetricCheckBox>
                    })}
                </div>
                <div
                    style={{
